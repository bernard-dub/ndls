...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference("Translation.count") do
      post translations_url, params: { translation: { lesson_id: @translation.lesson_id, original: @translation.original, translated: @translation.translated } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { lesson_id: @translation.lesson_id, original: @translation.original, translated: @translation.translated } }
